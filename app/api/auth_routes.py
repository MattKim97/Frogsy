...
from app.forms import SignUpForm, get_unique_filename, upload_file_to_s3, error_messages
...
def login():
    ...
    """
    form = LoginForm()
    print(f"Received login attempt with email: {form.data['email']}, password: {form.data['password']}")
